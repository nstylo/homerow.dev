module.exports = {
  siteMetadata: {
    title: `Homerow - Software Blog`,
    description: `A blog about software and my personal projects.`,
    author: `Niklas Stylianou`,
    siteUrl: `https://www.homerow.dev`,
  },
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: `featuredImages`,
        path: `${__dirname}/src/featuredImages/`,
      },
    },
